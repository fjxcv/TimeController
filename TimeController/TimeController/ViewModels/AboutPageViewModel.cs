    ...
    public class AboutPageViewModel : INotifyPropertyChanged
    {
        ...
        public AboutPageViewModel()
        {
            ...
            TutorialSteps = new ObservableCollection<string>
            {
                ...
                "   5. 右边有“长期备忘”可查看不限期的任务，右下角“本周复盘”查看周数据反馈。",
                "   6. 每周的已完成任务会在新的一周变为未完成。",
                "",
                "🎯【强目标管理模式】",
                "   1. 点击导航栏“强目标管理模式”进入。",
                "   2. 在“周视图”中，横向展示全天任务和周一至周日的时间轴（0:00–24:00）：",
                "      · 点击空白区域，出现加号，可点击添加时段任务；勾选标记完成。",
                "   3. 在“月视图”中，显示当月日历网格，每日可显示最多3条任务，点击向下箭头可查看全部任务；",
                "      点击卡片即可添加任务",
                "   4. 切换到“复盘”页面，默认进入每日复盘页面，卡片给出：",
                "      · 已完成/未完成任务列表",
                "      · 今日未处理任务、以前未处理的任务：可选择推迟或放弃 ",
                "   5. · 每周复盘界面中，给出周任务完成与推迟/放弃的折线图，六张卡片给出不同分析建议。"
            };
            ...
            {
                "1. 双模式设计：",
                "   · 咸鱼日常：低门槛、低负担，通过可视化进度与周奖励，激发持续行动。",
                "   · 强目标管理：周视图+月视图+复盘，支持高强度项目或考试备考场景。",
                "",
                "2. 温和驱动力：",
                "   · 不强行“逼”完成，而是通过“完成感”与正反馈，让行动成为习惯。",
                "",
                "3. 数据智能：",
                "   · 复盘模块自动统计完成数、最勤奋模块、未添加模块，生成个性化建议。",
                "",
                "4. 为“非理性用户”而生：",
                "   · 针对拖延、注意力分散等特质，提供“易开始”“易坚持”“易复盘”的交互。",
            };
